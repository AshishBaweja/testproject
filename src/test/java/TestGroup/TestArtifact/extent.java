...
public class extent extends BaseTest {
	...
	//		String extentReportImage = System.getProperty("user.dir") + "\\extentReportImage.png";
			...
			// Verify title.
			try {
			Assert.assertTrue(title.equals("Best Programming and Testing Tutorials for Programmers & Testers"));
			...
			String screenShotPath = Getscreenshot(driver, "SampleTest");
